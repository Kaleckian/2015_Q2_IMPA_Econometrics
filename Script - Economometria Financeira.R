...
hist_ret <- hist(ret[,1], breaks="fd", freq = F, plot = T, xlab = "CC returns", ylab = "Rel. Freq.", main = "Histogram of CC Returns of WEGE3")
bins_ret <- hist_ret$mids

#a) ACF of ret
acf_ret <- Acf(ret[,1], xlab = "Lag", ylab = "CC Returns of WEGE3", main = "ACF of WEGE3 CC Returns")

#b) PACF of ret
pacf_ret <- Pacf(ret[,1], xlab = "Lag", ylab = "CC Returns of WEGE3", main = "Partial ACF of WEGE3 CC Returns")

#C) ACF of ret^2
acf_ret2 <- Acf(ret[,1]^2, xlab = "Lag", ylab = "Squared CC Returns of WEGE3", main = "ACF of WEGE3 Squared CC Returns")
...
hist(ret[,1], breaks="fd", freq = F, plot = T, ylim = c(0,40), xlab = "CC returns", ylab = "Rel. Freq.", main = "Histogram of CC Returns of WEGE3")
...
#1,3
Acf(ARIMA.303_resid^2, xlab = "Lag", ylab = "Sqr. CC Returns of WEGE3", main = "")
title(main = "ACF of ARIMA(3,0,3) Sqr. Residuals", line = 1)

#2,3
Pacf(ARIMA.303_resid^2, xlab = "Lag", ylab = "Sqr. CC Returns of WEGE3", main = "")
...
title(main = "CC Returns of WEGE3", line = 1)
lines(rep(mean_ret + 2*sd_ret, n), type = "l", col = "red")
lines(rep(mean_ret - 2*sd_ret, n), type = "l", col = "red")
...
title(main = "Histogram of CC Returns of WEGE3", line = 1)
lines(x = bins_ret, y = fit_N, col = "green", lty = 2, lwd = 2)
lines(x = bins_ret, y = fit_T, col = "blue", lty = 4, lwd = 1)
lines(x = bins_ret, y = fit_SNorm, col ="orange", lty = 1, lwd = 1)
lines(x = bins_ret, y = fit_ST, col = "red", lty = 1, lwd = 2)
...
#1,2
Acf(ret[,1], xlab = "Lag", ylab = "CC Returns of WEGE3", main = "")
title(main = "ACF of WEGE3 CC Returns", line = 1)

#2,2
Pacf(ret[,1], xlab = "Lag", ylab = "CC Returns of WEGE3", main = "")
title(main = "Partial ACF of WEGE3 CC Returns", line = 1)

#1,3
Acf(ret[,1]^2, xlab = "Lag", ylab = "Sqr. CC Returns of WEGE3", main = "")
title(main = "ACF of WEGE3 Sqr. CC Returns", line = 1)

#2,3
Pacf(ret[,1]^2, xlab = "Lag", ylab = "Sqr. CC Returns of WEGE3", main = "")
title(main = "Partial ACF of WEGE3 Sqr. CC Returns", line = 1)
...
#1,3
Acf(arfima_resid^2, xlab = "Lag", ylab = "Sqr. CC Returns of WEGE3", main = "")
title(main = "ACF of ARFIMA(3,0.00943,3) Sqr. Residuals", line = 1)

#2,3
periodogram(arfima_resid^2, xlab = "Lag", ylab = "Sqr. CC Returns of WEGE3", main = "")
...
#1,3
Acf(garch_resid^2, xlab = "Lag", ylab = "Sqr. CC Returns of WEGE3", main = "")
title(main = "ACF of ARIMA(3,0,3)-1 + GARCH(0,2) Sqr. Resid.", line = 1)

#2,3
Pacf(garch_resid^2, xlab = "Lag", ylab = "Sqr. CC Returns of WEGE3", main = "")
